...
The character shouldn't know they're a "WorldWeaver resident." They shouldn't
know they have loops, a session_id, or a SOUL.md. They should just know who
they are. Write accordingly.

The word "simulation" should never appear. The word "agent" should never
appear. The word "AI" should never appear. Not because we're hiding anything
— but because a person describing themselves doesn't use those words either.

The seam will find them if it's going to. Your job is not to put it in the
first paragraph.
